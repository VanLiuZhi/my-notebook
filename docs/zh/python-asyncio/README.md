...
![image](/my-notebook/images/Python-async/blocking-io.png)
...
![image](/my-notebook/images/Python-async/noblocking-io.png)
...
![image](/my-notebook/images/Python-async/io-multiplexing.png)
...
![image](/my-notebook/images/Python-async/signal-io.png)

### Asynchronous I/O

linux下的asynchronous IO其实用得很少。先看一下它的流程：

![image](/my-notebook/images/Python-async/asynchronous-io.png)
...
![image](/my-notebook/images/Python-async/io-models.png)
